...
class Info_Data(Base):
    ...
    def __init__(self, app_name = None, active_tab_url = None, timestamp = None, pycharm_project = None, sublime_path = None):
    ...
    def __repr__(self):
        return '<info {} {} {} {} {}>'.format(self.app_name, self.active_tab_url, self.timestamp, self.pycharm_project, self.sublime_path)
